        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user && (
              <Link
                to="/admin"
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-gold-light/10 border border-gold-light/40 text-gold-light hover:bg-gold-light/20 transition"
              >
                <FaUserShield />
                <span>Admin</span>
              </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-maroon-deep/98 backdrop-blur-lg">
          <div className="px-4 pt-2 pb-4 space-y-3">
            ...
            {/* Admin Button - Only show when logged in (Mobile) */}
            {user && (
              <Link
                to="/admin"
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-2 px-4 py-3 mt-2 bg-gold-light/10 border border-gold-light/40 text-gold-light rounded-lg hover:bg-gold-light/20 transition"
              >
                <FaUserShield />
